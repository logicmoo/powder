...
input_spec(todo_create,obj([req(revision,str(64,64)),req(mt,nullable(str(1,4096))),req(data,Data)])) :-
    data_spec(Data).
input_spec(todo_update,obj([req(revision,str(64,64)),req(id,str(1,128)),req(resourceRevision,str(64,64)),
    req(mt,nullable(str(1,4096))),req(data,Data)])) :- data_spec(Data).
input_spec(todo_delete,obj([req(revision,str(64,64)),req(id,str(1,128)),req(resourceRevision,str(64,64))])).
...
inverse_spec(obj([req(revision,str(64,64)),req(changeset,str(1,128))])).
